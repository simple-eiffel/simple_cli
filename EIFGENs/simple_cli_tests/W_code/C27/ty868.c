...
extern EIF_TYPED_VALUE F868_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F868_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 867, Current, 0, 0, 3168);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(867, Current, 3168);
	RTIV(Current, RTAL);
