...
extern EIF_TYPED_VALUE F869_3791(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_3794(EIF_REFERENCE);
extern void F869_6828(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F869_3791 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 5364);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(868, Current, 5364);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F869_3794 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 5365);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(868, Current, 5365);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F869_6828 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 868, Current, 0, 6827);
	RTSA(dtype);
	RTME(dtype, 0);
