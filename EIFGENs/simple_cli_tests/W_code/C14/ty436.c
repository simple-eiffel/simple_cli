...
extern EIF_TYPED_VALUE F436_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F436_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 435, Current, 0, 0, 3157);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(435, Current, 3157);
	RTIV(Current, RTAL);
