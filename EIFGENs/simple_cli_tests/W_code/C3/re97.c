...
extern EIF_TYPED_VALUE F97_1407(EIF_REFERENCE);
...
EIF_TYPED_VALUE F97_1407 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 96, Current, 0, 0, 1427);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1408, 128))(Current)).it_i4);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 96, Current, 0, 0, 1428);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
