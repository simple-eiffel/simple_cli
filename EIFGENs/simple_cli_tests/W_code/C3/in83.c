...
extern void F83_1336(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 82, Current, 1, 0, 1353);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1245, dtype))(Current, up1x);
	RTHOOK(3);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 82, Current, 0, 0, 1354);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {534,232,0xFFFF};
		EIF_TYPE typres0;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 82, Current, 0, 0, 1355);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F83_1336 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
