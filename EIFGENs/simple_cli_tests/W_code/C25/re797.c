...
extern EIF_TYPED_VALUE F797_3791(EIF_REFERENCE);
extern EIF_TYPED_VALUE F797_3794(EIF_REFERENCE);
extern void F797_6828(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F797_3791 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 5358);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 5358);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F797_3794 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 796, Current, 0, 0, 5359);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(796, Current, 5359);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F797_6828 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 796, Current, 0, 6827);
	RTSA(dtype);
	RTME(dtype, 0);
