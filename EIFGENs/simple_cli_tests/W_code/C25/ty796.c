...
extern EIF_TYPED_VALUE F796_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F796_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 795, Current, 0, 0, 3166);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(795, Current, 3166);
	RTIV(Current, RTAL);
