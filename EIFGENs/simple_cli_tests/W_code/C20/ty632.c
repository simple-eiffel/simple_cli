...
extern EIF_TYPED_VALUE F632_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F632_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 631, Current, 0, 0, 3162);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(631, Current, 3162);
	RTIV(Current, RTAL);
