...
extern EIF_TYPED_VALUE F760_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F760_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 759, Current, 0, 0, 3165);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(759, Current, 3165);
	RTIV(Current, RTAL);
