...
static const EIF_TYPE_INDEX egt_0_16 [] = {0xFF01,257,0xFFFF};
static const EIF_TYPE_INDEX egt_1_16 [] = {0xFF01,279,15,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_16 [] = {0xFF01,257,0xFFFF};
static const EIF_TYPE_INDEX egt_10_16 [] = {0xFF01,257,0xFFFF};
static const EIF_TYPE_INDEX egt_11_16 [] = {0xFF01,18,0xFFFF};
...
static const struct desc_info desc_16[] = {
	...
	{EIF_NON_GENERIC(0x022B /*277*/), 313, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x022B /*277*/), 314, 0},
	{EIF_NON_GENERIC(0x01EF /*247*/), 315, 0xFFFFFFFF},
};
void Init16(void)
{
	IDSC(desc_16, 0, 15);
	IDSC(desc_16 + 1, 4, 15);
	IDSC(desc_16 + 32, 142, 15);
}
