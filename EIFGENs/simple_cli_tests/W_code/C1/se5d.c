...
static const EIF_TYPE_INDEX egt_0_5 [] = {0xFF01,257,0xFFFF};
static const EIF_TYPE_INDEX egt_1_5 [] = {0xFF01,279,4,0xFFFF};
...
static const EIF_TYPE_INDEX egt_9_5 [] = {0xFF01,257,0xFFFF};
static const EIF_TYPE_INDEX egt_10_5 [] = {0xFF01,257,0xFFFF};
static const EIF_TYPE_INDEX egt_11_5 [] = {0xFF01,18,0xFFFF};
...
static const struct desc_info desc_5[] = {
	...
	{EIF_NON_GENERIC(0x01C5 /*226*/), 63, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01C5 /*226*/), 64, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01C5 /*226*/), 65, 0xFFFFFFFF},
};
void Init5(void)
{
	IDSC(desc_5, 0, 4);
	IDSC(desc_5 + 1, 4, 4);
	IDSC(desc_5 + 32, 267, 4);
}
