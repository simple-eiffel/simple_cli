...
extern void F4_6780(EIF_REFERENCE, int);
...
body:;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(58, dtype)) = (EIF_INTEGER_32) arg1;
	...
	ui4_1 = ti4_1;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1980, "field_count_of_type", tr1))(tr1, ui4_1x)).it_i4);
	loc1 = (EIF_INTEGER_32) ti4_1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 63, 0xF800019F, 0); /* mismatches_by_name */
	...
	*(EIF_REFERENCE *)(Current + RTWA(63, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 64, 0xF80001A5, 0); /* mismatches_by_stored_position */
...
#define up1 up1x.it_p
	...
	if (arg1) {
		RTCC(arg1, 3, l_feature_name, 1, eif_new_type(256, 0x00), 0x00);
	}
	if (arg2) {
		RTCC(arg2, 3, l_feature_name, 2, eif_new_type(256, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 61, 0xF8000100, 0); /* old_version */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(61, dtype)) = (EIF_REFERENCE) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 62, 0xF8000100, 0); /* new_version */
	RTAR(Current, arg2);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg3, 3, l_feature_name, 3, eif_new_type(257, 0x01), 0x01);
	RTCC(arg4, 3, l_feature_name, 4, eif_new_type(257, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,0xFFF9,9,209,0xFF01,257,0xFF01,257,214,214,214,214,247,247,247,0xFFFF};
		EIF_TYPE typres0;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTCC(arg2, 3, l_feature_name, 2, eif_new_type(257, 0x01), 0x01);
	RTCC(arg3, 3, l_feature_name, 3, eif_new_type(257, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
void F4_6780 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 3, Current, 0, 6779);
	RTSA(dtype);
	RTME(dtype, 0);
