...
extern EIF_TYPED_VALUE F19_328(EIF_REFERENCE);
extern EIF_TYPED_VALUE F19_329(EIF_REFERENCE);
extern EIF_TYPED_VALUE F19_330(EIF_REFERENCE);
extern EIF_TYPED_VALUE F19_331(EIF_REFERENCE);
extern EIF_TYPED_VALUE F19_332(EIF_REFERENCE);
extern EIF_TYPED_VALUE F19_333(EIF_REFERENCE);
extern EIF_TYPED_VALUE F19_334(EIF_REFERENCE);
...
RTOID (F19_328)
EIF_TYPED_VALUE F19_328 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRB(EIF_CHARACTER_8)
	RTOTDB(EIF_CHARACTER_8, F19_328);
	dtype = Dtype(Current);
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 342);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(333, dtype))(Current)).it_c1);
...
RTOID (F19_329)
EIF_TYPED_VALUE F19_329 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 343);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F19_330 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 344);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F19_331 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 345);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F19_332 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 346);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F19_333 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 18, Current, 0, 0, 347);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(18, Current, 347);
...
EIF_TYPED_VALUE F19_334 (EIF_REFERENCE Current)
{
	GTCX
