...
extern EIF_TYPED_VALUE F724_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F724_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 723, Current, 0, 0, 3164);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(723, Current, 3164);
	RTIV(Current, RTAL);
