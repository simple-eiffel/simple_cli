...
extern EIF_TYPED_VALUE F688_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F688_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 687, Current, 0, 0, 3163);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(687, Current, 3163);
	RTIV(Current, RTAL);
