...
extern EIF_TYPED_VALUE F468_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F468_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 467, Current, 0, 0, 3158);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(467, Current, 3158);
	RTIV(Current, RTAL);
