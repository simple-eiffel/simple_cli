...
extern EIF_TYPED_VALUE F907_3328(EIF_REFERENCE);
...
EIF_TYPED_VALUE F907_3328 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 906, Current, 0, 0, 4594);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(906, Current, 4594);
	RTIV(Current, RTAL);
	RTHOOK(1);
