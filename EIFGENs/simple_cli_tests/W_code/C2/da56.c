...
extern EIF_TYPED_VALUE F56_1019(EIF_REFERENCE);
extern EIF_TYPED_VALUE F56_1020(EIF_REFERENCE);
extern EIF_TYPED_VALUE F56_1021(EIF_REFERENCE);
...
EIF_TYPED_VALUE F56_1019 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F56_1020 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F56_1021 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 55, Current, 0, 0, 1052);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(927, "fractional_second", tr1));
