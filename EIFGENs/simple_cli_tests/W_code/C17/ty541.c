...
extern EIF_TYPED_VALUE F541_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F541_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 540, Current, 0, 0, 3160);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(540, Current, 3160);
	RTIV(Current, RTAL);
