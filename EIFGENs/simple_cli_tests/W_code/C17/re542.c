...
extern EIF_TYPED_VALUE F542_3791(EIF_REFERENCE);
extern EIF_TYPED_VALUE F542_3794(EIF_REFERENCE);
extern void F542_6828(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F542_3791 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 541, Current, 0, 0, 5340);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(541, Current, 5340);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F542_3794 (EIF_REFERENCE Current)
{
	GTCX
...
void F542_6828 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 541, Current, 0, 6827);
	RTSA(dtype);
	RTME(dtype, 0);
