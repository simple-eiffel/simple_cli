...
extern EIF_TYPED_VALUE F375_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F375_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 374, Current, 0, 0, 3156);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(374, Current, 3156);
	RTIV(Current, RTAL);
