...
extern EIF_TYPED_VALUE F299_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F299_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 298, Current, 0, 0, 3154);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(298, Current, 3154);
	RTIV(Current, RTAL);
