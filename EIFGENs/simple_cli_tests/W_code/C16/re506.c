...
extern EIF_TYPED_VALUE F506_3791(EIF_REFERENCE);
extern EIF_TYPED_VALUE F506_3794(EIF_REFERENCE);
extern void F506_6828(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F506_3791 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 505, Current, 0, 0, 5337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(505, Current, 5337);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F506_3794 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 505, Current, 0, 0, 5338);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(505, Current, 5338);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F506_6828 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 505, Current, 0, 6827);
	RTSA(dtype);
	RTME(dtype, 0);
