...
extern EIF_TYPED_VALUE F505_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F505_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 504, Current, 0, 0, 3159);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(504, Current, 3159);
	RTIV(Current, RTAL);
