...
extern EIF_TYPED_VALUE F338_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F338_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 337, Current, 0, 0, 3155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(337, Current, 3155);
	RTIV(Current, RTAL);
