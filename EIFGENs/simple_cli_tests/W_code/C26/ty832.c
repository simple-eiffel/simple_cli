...
extern EIF_TYPED_VALUE F832_3117(EIF_REFERENCE);
...
EIF_TYPED_VALUE F832_3117 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 831, Current, 0, 0, 3167);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(831, Current, 3167);
	RTIV(Current, RTAL);
